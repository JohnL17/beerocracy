defmodule Beerocracy.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      BeerocracyWeb.Endpoint
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: Beerocracy.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    BeerocracyWeb.Endpoint.config_change(changed, removed)
    :ok
  end
