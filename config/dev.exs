...
config :beerocracy, BeerocracyWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "0IGrZ6QTe3c1y61gIIfk46lIzHy0hnTQBsrIzMMo80VY6rrzbQ1yeDj1QmEYnCnA",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:beerocracy, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:beerocracy, ~w(--watch)]}
  ]
...
config :beerocracy, BeerocracyWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/beerocracy_web/router\.ex$"E,
      ~r"lib/beerocracy_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
